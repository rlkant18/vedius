...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_backendservice) {
        ...
        this.counter = 0;
        this.userStatusColor = "warn";
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.counter = 0;
        this.configData = this._backendservice.getCartTotal();
        this._backendservice.getCartTotal().subscribe(function (res) {
            _this.counter = res;
        });
        this._backendservice.getUserStatus().subscribe(function (res) {
            _this.userStatusColor = res ? "primary" : "warn";
        });
    };
    __decorate([
        core_1.Input(),
